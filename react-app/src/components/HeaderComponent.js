...
import { NavItem, Nav, Navbar, NavbarBrand, NavbarToggler, Collapse} from 'reactstrap'
            ...
            <div className="header">
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto" href="/" to='/home'><img src='assets/images/logo.png' height="30" width="41" alt='Ristorante Con Fusion' /></NavbarBrand>
